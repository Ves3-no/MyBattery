...
function Nav({KmStand, SeasonNow, Battery, setBattery, setKmStand, AvrageKmThisSeason, KmSinceLastCharge, setKmSinceLastCharge, setPrevTrips, PrevTrips}: {
  KmStand: number;
  SeasonNow: Season;
  Battery: number;
  ...
  PrevTrips: Trip[]
    ...
    return(
        <>
            <nav className="h-18 bg-main w-full fixed bottom-0 z-10 flex items-center justify-around px-4 p-2">
                <button className="text-main-light hover:text-main-dark"><Home fill="currentColor"/></button>
                ...
                <button><Settings className="text-main-light" fill="currentColor"/></button>
            </nav>
