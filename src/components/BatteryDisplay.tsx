    ...
    return(
        <>
            <div className="flex flex-col bg-light w-full rounded-2xl px-5 py-7 border-main-light border gap-2">
                ...
                <div><h1 className="text-main text-xs ">Gjendstående kjørelengde: <span className='text-dark font-bold text-3xl'>{String(Math.round(Number((AvrageKmThisSeason/100)*Battery)))}</span>Km</h1></div>
                <div>
